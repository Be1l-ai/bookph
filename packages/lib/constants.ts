...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://bookph.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "BookPH";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@bookph.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "BookPH";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "BookPH";
...
export const LOGO = "/bookph-logo-white-word.svg";
export const LOGO_ICON = "/bookph-icon-white.svg";
...
export const ROADMAP = "https://bookph.com/roadmap";
export const DESKTOP_APP_LINK = "https://bookph.com/download";
export const JOIN_COMMUNITY = "https://github.com/Be1l-ai/bookph/discussions";
export const POWERED_BY_URL = "https://bookph.com/booking";
export const DOCS_URL = "https://bookph.com/docs";
export const DEVELOPER_DOCS = "https://developer.bookph.com";
...
// Philippine flag colors: Blue #0038A8, Yellow #FCD116, Red #CE1126
export const DEFAULT_LIGHT_BRAND_COLOR = "#0038A8";
export const DEFAULT_DARK_BRAND_COLOR = "#FCD116";
...
export const WEBSITE_PRIVACY_POLICY_URL =
  process.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL || "https://bookph.com/privacy";
export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://bookph.com/terms";
